...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { description: @portfolio.description, portfolio_image: @portfolio.portfolio_image, titel: @portfolio.titel } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { description: @portfolio.description, portfolio_image: @portfolio.portfolio_image, titel: @portfolio.titel } }
