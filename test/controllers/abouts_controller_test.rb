...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { description: @about.description, profile_Picture: @about.profile_Picture, social: @about.social } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { description: @about.description, profile_Picture: @about.profile_Picture, social: @about.social } }
